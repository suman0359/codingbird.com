    ...
    <div class="container">
        <div class="row" >
            ...
            <div class="col-md-3 pull-right col-md-offset-6" style="height: 70px;">
                <h2 class="text-right">
                    <a style="color: #313447;" href="#">Home/Checkout</a>
                </h2>
            </div>
        </div>
    </div>
    ...
    <form action="" method="POST">
        <div class="row">
            ...
            <div class="col-md-6"> <!-- Second Column -->
                ...
                <div class="form-group">
                    <label for="labelForOrderInfo">Order Info</label>
                    <table class="table table-bordered table-striped table-hover">
                        ...
                        <tbody>
                            <tr>
                                <td>1</td>
                                <td>Facebook Cover Design</td>
                                <td>
                                    <div class="input-group"  style="float: left; width: 50px;">
                                        <input type="number" value="1" class="form-control order-details-quantity" size="4">
                                    </div>
                                </td>
                                <td>$300</td>
                                <td>$1500</td>
                ...
                <div id="payment" class="woocommerce-checkout-payment">
                    <ul class="payment_methods methods">
                        <li class="payment_method_paypal">
                            ...
                            <label for="payment_method_paypal">
                                PayPal <img src="img/paypal.png" alt="PayPal Acceptance Mark">
                                <a href="https://www.paypal.com/us/webapps/mpp/paypal-popup" class="about_paypal" onclick="javascript:window.open('https://www.paypal.com/us/webapps/mpp/paypal-popup', 'WIPaypal', 'toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=yes, resizable=yes, width=1060, height=700');
                    ...
                    <div class="form-row place-order">
                        ...
                        <input type="hidden" id="_wpnonce" name="_wpnonce" value="c4e14ce9c1">
                        <input type="hidden" name="_wp_http_referer" value="/wp-admin/admin-ajax.php">

                        <input type="submit" class="button btn btn-primary alt" name="woocommerce_checkout_place_order" id="place_order" value="Proceed to PayPal" data-value="Place order">
