    ...
    <div class="row">
        <div class="col-md-6">
            <form action="<?php echo base_url() . "my_account/update_my_account" ?>" method="POST">
                <div class="row personal-details-left">
                    <div class="col-md-12">
                ...
                <div class="row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" name="first_name" placeholder="First Name" class="form-control" value="<?php echo $user_info->first_name; ?>">
                    </div>

                    <div class="form-group col-md-6 pull-right">
                        <label for="labelForLastName">Last Name</label>
                        <input type="text" name="last_name" placeholder="Last Name" class="form-control" value="<?php echo $user_info->last_name; ?>">
                    </div>
                </div>

                <div class="form-group">
                    <label for="">Email Address</label>
                    <input type="email" name="email" class="form-control" placeholder="Email Address" value="<?php echo $user_info->email_address; ?>" />
                </div>
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="date" name="date" class="form-control" placeholder="Date of Birth"  value="<?php echo $user_info->date_of_birth; ?>" />
                    </div>

                    <div class="form-group col-md-6">
                        <label for="labelForLastName">Phone Number</label>
                        <input type="number" name="phone" placeholder="Phone Number" class="form-control" value="<?php echo $user_info->phone_no; ?>">
                    </div>
        ...
        <div class="col-md-6">
            ...
            <form action="<?php echo base_url() . "my_account/update_billing_address_info"; ?>" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="form-group pull-right">
                            <button type="submit" name="update-account" class="btn btn-primary">Update Billing Address</button>
                        </div>
                    </div>
                </div>
